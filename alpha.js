...
const absen = JSON.parse(fs.readFileSync('./lib/absen.json'))
...
tamnel = fs.readFileSync('./thumb.jpg')
...
try {
	    ...
	    if (multi){
		    var prefix = /^[°zZ${prefix}$@*+,.#?=''():√%!¢£¥€π¤ΠΦ_&><`™©®Δ^βα¦|/\\©^]/.test(cmd) ? cmd.match(/^[°zZ#$@*+,.?=''():√%¢£¥€π¤ΠΦ_&><!`™©®Δ^βα¦|/\\©^]/gi) : '.'
        } else {
            if (nopref){
                prefix = ''
            } else {
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6283856223089/6283856223089`}}})
		}
		const simir = (teks) => {
...
if(isButton == 'igm'){
reply('http://instagram.com/xgame.sanz._')
}
if(isButton == 'ytm'){
...
───────────────────`
buttons = [
{buttonId:`gzmenu`, buttonText: {displayText: 'SEMUA MENU'}, type: 1},
{buttonId:`listmenu`,buttonText:{displayText: 'MENU SIMPEL'},type:1},
...
alpha.sendMessage(from, sound, MessageType.audio, {quoted: ftex, mimetype: 'audio/mp4', ptt:true})
break
case 'allmenu': case 'gzmenu':
...
alpha.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:ftex, contextInfo: { mentionedJid: [sender]}})
	         console.log(color('[ VERIFIKASI ]'), color(time, 'yellow'), 'Serial:', color(serialUser, 'cyan'), 'in', color(sender || groupName))
	    // console.log(e)
        break
case 'simplemenu':
case 'listmenu':
...
{buttonId:`listmenu`, buttonText: {displayText: '♡Simpel Menu♡'}, type: 1},
{buttonId:`sc`,buttonText:{displayText: ' ❀Script Bot❀'},type:1},
{buttonId:`owner`, buttonText: {displayText: '亗ᴏᴡɴᴇʀ ʙᴏᴛ亗'}, type: 1}
]
const soundM = {
    contentText: `${stamtus}`,
    footerText: `_error atau bug harap lapor ke owner_\n_bot dalam proses pengembangan_\n_mohon maaf jika fitur kurang lengkap_`,
...
冬${prefix}antidelete
冬${prefix}bc [ teks ]
冬${prefix}tobc [ reply sticker ]
冬${prefix}return [ javascript ]
冬${prefix}clearall
冬${prefix}delchat
冬${prefix}mute
冬${prefix}unmute
冬${prefix}public
冬${prefix}self
冬${prefix}spam [ teks|jumlah ]
冬${prefix}demoteall
冬${prefix}promoteall
冬${prefix}addcmd [ teks reply stc ]
冬${prefix}delcmd [ reply stc ]
冬${prefix}listcmd
冬${prefix}spamsw [ teks|jumlah ]
冬${prefix}upswteks [ teks ]
冬${prefix}upswlokasi [ teks ]
冬${prefix}upswaudio [ reply audio ]
冬${prefix}upswvoice [ reply audio ]
冬${prefix}upswsticker [ reply sticker ]
冬${prefix}upswimage [ reply image ]
冬${prefix}upswgif [ reply gif ]
冬${prefix}upswvideo [ reply video ]
冬${prefix}shutdown
冬${prefix}offline [ alasan ]
冬${prefix}online
冬${prefix}exif [ nama|author ]
冬${prefix}setprofile [ reply image ]
冬${prefix}setname [ teks ]
冬${prefix}setprefix [ multi/nopref/prefix ]
冬${prefix}setbio [ teks ]
冬${prefix}leave
冬${prefix}restart
冬${prefix}addrespon [ tanya|jawab ]
冬${prefix}delrespon [ nama ]
冬${prefix}listrespon
冬${prefix}readall
冬${prefix}unreadall
冬${prefix}archive
...
冬${prefix}pin
冬${prefix}unpin
冬${prefix}setmenu [ ori/simpel ]
冬${prefix}setallmenu [ ori/simpel ]
冬${prefix}leavetime [ detik/menit/jam ]
冬${prefix}bukatime [ detik/menit/jam ]
冬${prefix}tutuptime [ detik/menit/jam ]
冬${prefix}nano [ nama file ]
────────────────────`
buttons = [
{buttonId:`listmenu`, buttonText: {displayText: '♡Simpel Menu♡'}, type: 1},
{buttonId:`sc`,buttonText:{displayText: ' ❀Script Bot❀'},type:1},
...
冬${prefix}infogempa
冬${prefix}herolist
冬${prefix}herodetail [ hero ]
冬${prefix}google [ search ]
冬${prefix}gimage [ search ]
冬${prefix}wiki [ search ]
冬${prefix}mediafire [ link ]
冬${prefix}ytmp4 [ link yt ]
冬${prefix}ytmp3 [ link yt ]
冬${prefix}play [ judul lagu ]
冬${prefix}video [ judul video ]
冬${prefix}tinyurl [ link ]
冬${prefix}fetch [ link ]
冬${prefix}igdl [ link ]
冬${prefix}tiktokdl [ link ]
冬${prefix}pinterest [ search ]
冬${prefix}lirik [ judul ]
冬${prefix}tourl [ reply image/video ]
冬${prefix}resepmasakan [ judul ]
冬${prefix}artimimpi [ teks ]
冬${prefix}bilangangka [ angka ]
冬${prefix}kalkulator [ angka ]
冬${prefix}fancytext [ teks ]
冬${prefix}githubstalk [ username ]
冬${prefix}translate [ teks kodebhs ]
冬${prefix}ss [ link ]
...
stamtus =`❏ 「 \`\`\`MENU ANIME\`\`\` 」
────────────────────
Pilih Anime Nya Kakak
────────────────────
冬${prefix}chiisaihentai「 hentai 」
冬${prefix}ahegao「 hentai 」
冬${prefix}hololewd「 hentai 」
冬${prefix}sideoppai「 hentai 」
冬${prefix}animefeets「 hentai 」            
冬${prefix}animebooty「 hentai 」
冬${prefix}animethighss「 hentai 」
冬${prefix}hentaiparadise「 hentai 」
冬${prefix}animearmpits「 hentai 」
冬${prefix}hentaifemdom「 hentai 」
冬${prefix}lewdanimegirls「 hentai 」
冬${prefix}biganimetiddies「 hentai 」
冬${prefix}animebellybutton「 hentai 」
 冬${prefix}hentai4everyone「 hentai 」
────────────────────`
buttons = [
...
await alpha.sendMessage(from, AnimeM, MessageType.buttonsMessage, {quoted: ftex})
break
case 'makermenu':
stamtus =`❏ 「 \`\`\`MENU MAKER\`\`\` 」
────────────────────
_contoh: ${prefix}tahta NAMA_
────────────────────
冬${prefix}nulis「 text 」
冬${prefix}multicolor3d「 text 」
冬${prefix}watercolor「 text 」
冬${prefix}luxurygold「 text 」
冬${prefix}galaxywallpaper「 text 」
冬${prefix}lighttext「 text 」
冬${prefix}beautifulflower「 text 」
冬${prefix}puppycute「 text 」
冬${prefix}royaltext「 text 」
冬${prefix}heartshaped「 text 」
冬${prefix}birthdaycake「 text 」
冬${prefix}galaxystyle「 text 」
冬${prefix}hologram3d
冬${prefix}snow 「 text 」
冬${prefix}cans 「 text 」
冬${prefix}ganz 「 text 」
冬${prefix}glossychrome
冬${prefix}greenbush 「 text 」
冬${prefix}metallogo「 text 」
冬${prefix}noeltext「 text 」
冬${prefix}glittergold「 text 」
冬${prefix}textcake「 text 」
冬${prefix}starsnight「 text 」
冬${prefix}wooden3d「 text 」
冬${prefix}textbyname「 text 」
冬${prefix}galaxybat「 text 」
冬${prefix}writegalacy「 text 」
冬${prefix}snow3d「 text 」
冬${prefix}birthdayday「 text 」
冬${prefix}wetglass「 text 」
冬${prefix}goldplaybutton「 text 」
冬${prefix}silverplaybutton「 text 」
冬${prefix}freefire「 text 」
冬${prefix}pornhub「 text 」
冬${prefix}glitch「 text 」
冬${prefix}space「 text 」
冬${prefix}avenger「 text 」
冬${prefix}ninjalogo「 text 」
冬${prefix}lionlogo「 text 」
冬${prefix}marvelstudio「 text 」
冬${prefix}wolflogo「 text 」
冬${prefix}steel3d「 text 」
冬${prefix}wallgravity「 text 」
────────────────────`
buttons = [
{buttonId:`command`,buttonText:{displayText:'😾️Menu Bot😾️'},type:1},
{buttonId:`listmenu`, buttonText: {displayText: '♡Simpel Menu♡'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: '亗ᴏᴡɴᴇʀ ʙᴏᴛ亗'}, type: 1}
]
const makerM = {
...
stamtus =`❏ 「 \`\`\`MENU OTHER\`\`\` 」
────────────────────
冬${prefix}caripesan [ teks|jumlah ]
冬${prefix}slots
冬${prefix}suit [ gunting/batu/kertas ]
冬${prefix}tag [ nomor ]
冬${prefix}tagme
冬${prefix}tts [ kodebhs teks ]
冬${prefix}readmore [ teks1|teks2 ]
冬${prefix}fitnahpc [ nomor|teks1|teks2 ]
冬${prefix}chat [ nomor|teks ]
冬${prefix}fdeface [ replyimg link|teks1|teks2 ]
冬${prefix}listimage
冬${prefix}liststicker
冬${prefix}listvn
冬${prefix}bokep
冬${prefix}listgrup
冬${prefix}baileys [ reply message ]
冬${prefix}q [ reply message ]
冬${prefix}getcaption [ reply message ]
冬${prefix}pantun
冬${prefix}tospam [ reply sticker|jumlah ]
冬${prefix}sharelock [ teks1|teks2 ]
冬${prefix}sticker
冬${prefix}stickerwm [ nama|author ]
冬${prefix}takestick [ nama|author ]
冬${prefix}colong [ reply sticker ]
冬${prefix}dadu
冬${prefix}semoji [ emoji ]
冬${prefix}attp [ teks ]
冬${prefix}toimg
冬${prefix}tomp3 [ reply video ]
冬${prefix}tomp4 [ reply sticker gif ]
冬${prefix}robot [ reply audio ]
冬${prefix}balik [ reply audio ]
冬${prefix}bass [ reply audio ]
冬${prefix}gemuk [ reply audio ]
冬${prefix}tupai [ reply audio ]
冬${prefix}reverse [ reply audio ]
冬${prefix}detikvn [ reply audio caption angka ]
冬${prefix}detikvideo [ reply video caption angka ]
────────────────────`
buttons = [
{buttonId:`listmenu`, buttonText: {displayText: '♡Simpel Menu♡'}, type: 1},
{buttonId:`iklan`, buttonText: {displayText: '☆Iklan Bot☆'}, type: 1},
...
case 'sound1':
      ...
      alpha.sendMessage(from, omkeh, MessageType.audio, { quoted: fvoc, mimetype: 'audio/mp4', ptt: true })
          break
case 'sound71':
      case 'sound71':
      case 'sound72':
      ...
      alpha.sendMessage(from, omkeh, MessageType.audio, { quoted: ftex, mimetype: 'audio/mp4', ptt: true })
          break      
...
//Jangan Lupa Subrek Yt LEX4YOU
case 'quotesmuslim': 
sticWait(from)
anu = await fetchJson(`https://lex4you-api.herokuapp.com/api/randomquote/muslim?apikey=Alphabot`)
get = anu.result
...
alpha.sendMessage(from, lolii, image, {quoted: mek, thumbnail: fs.readFileSync('./lib/Wahyuu.jpeg'), caption: 'Nih Bro Loli'})
break
//━━━━━━━━━━━━━━━[ FITUR NSFW ]━━━━━━━━━━━━━━━━━//
                
                case 'bokep':
               bokep = await getBuffer (`https://raku-web.herokuapp.com/api/bokep?apikey=RakuKeyTod`)
               alpha.sendMessage(from, bokep, video, {mimetype: 'video/mp4', quoted: ftex})
               break
//BATAS🗿
case 'attp':
if (args.length == 0) return reply(`Example: ${prefix + command} Hai`)
buffer = await getBuffer(`https://api.xteam.xyz/attp?file&text=${encodeURI(q)}`)
alpha.sendMessage(from, buffer, sticker, { quoted: ftex })
break
    case 'attp':  
                    if (args.length < 1) return reply(lang.noteks(prefix, command))
                    hhhh = q
                    anu1 = await getBuffer(`https://api.xteam.xyz/attp?file&text=${hhhh}`)
                    alpha.sendMessage(from, anu1, sticker, {quoted: ftrol})
                    break
case 'volume':
...
alpha.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: ftrol})
fs.unlinkSync(ran)
})
break
case 'gemuk':
                  ...
                  alpha.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, duration: 234, quoted:mek})
                     fs.unlinkSync(ran)
                  })
                  break
   case 'bass':                 
            ...
            alpha.sendMessage(from, buffer453, video, { mimetype: 'video/mp4', quoted: ftrol })
            fs.unlinkSync(ran)
            })
            break
case 'notif':					
            ...
            group = await alpha.groupMetadata(from);
...
alpha.sendMessage(from, hihi, audio, {mimetype: 'audio/mp4', ptt: true, quoted: ftrol})
fs.unlinkSync(ran)
	})
break
case 'absensi':
...
absen.push(sender)
fs.writeFileSync('./lib/absen.json', JSON.stringify(absen))
teks = `*LIST DAFTAR HADIR ABSEN*`
for (let sensi of absen) {
teks += `々 @${sensi.split('@')[0]} ✓`
}
teks += `TOTAL MEMBER YG ABSEN : ${absen.length}Ketik ${prefix}absensi untuk absen, Daftar list absen akan dikumpulkan setelah waktu yang diberikan telah berakhir!`
alpha.sendMessage(from, teks.trim(), extendedText, {quoted: mek, contextInfo: {"mentionedJid": absen}})
break
case 'cekhistory':
reply(` S T A T U S  T I C T A C T O E •> Win : ${checkWin(sender)}•> Lose : ${checkLose(sender)}`)
break
case 'delsesi':
...
case 'absen':
if (!isGroup) return reply(lang.onlygc())
if (args.length < 1) return reply(`Cara Memulai Absen Silahkan Ketik${prefix}absen waktu list menit yang tersedia.600000 | 1200000 | 1800000jadi ${prefix}absen 600000`)
tem = args.join(" ")
...
teks += `ABSENSI : ${sensi.length}Ketik ${prefix}absensi untuk absen, Daftar list absen akan dikumpulkan setelah waktu yang diberikan telah berakhir!`
reply(`List Presentasi Hadir Telah Siap Ketik ${prefix}absensi untuk absen, Daftar list absen akan dikumpulkan setelah waktu yang diberikan telah berakhir!`)
setTimeout( () => {
...
86 Diamond = Rp 23.000
172 Diamond = Rp 43.000
257 Diamond = Rp 63.000
344 Diamond = Rp 84.000
----------------------------------------------------------
Metode Pembayaran Diamond ML
Kami Menyediakan Via
👑Ovo  : prosess
👑Dana : Prosses
👑Pulsa :  prosess
👑Gopay : prosess
...
280 Diamond = Rp 70.000
460 Diamond = Rp 112.000
740 Diamond = Rp 178.000

[Note Diamond Masuk]
Tunggu 10 - 120 Menit
Open : 10:00 - 18:50 WIB

Cara Memesan Diamond MLBB
1. Pilih Nominal Diamond yang ingin kamu beli
2. Pilih Metode Pembayaran
3. Bayar Sesuai Dengan Nominal Diamond Yang Ingin Kamu Beli
4. Kirim Bukti Transfernya Kepada Kami
5. Kirimkan ID & Server Kamu
6. Tunggu Proses Pemasukan Diamond Sekitar 1 - 10 Menit
[Diamond Akan Terisi Otomatis]
7. Diamond Kamu Sudah Masuk

Termurah, Aman, Dan Tepercaya

♡Terimakasih Order Nya♡`)
break
//FunMenu
case 'bego':
      case 'tolol':
...
alpha.sendMessage(from, tomlol, image, { quoted:ftex,caption:'ᵈⁱˢᵘᵏᵃⁱ ᵒˡᵉʰ ᵏʳᵉᵃᵗᵒʳ' })
break
case 'nulis': 
...
alpha.sendMessage(from, catat, image, { quoted:ftex,caption:'ᵈⁱˢᵘᵏᵃⁱ ᵒˡᵉʰ ᵏʳᵉᵃᵗᵒʳ' })
break
case 'ganz': 
...
alpha.sendMessage(from, ganz, image, { quoted:ftex,caption:'ᵈⁱˢᵘᵏᵃⁱ ᵒˡᵉʰ ᵏʳᵉᵃᵗᵒʳ' })
break
case 'doge':
              reply(mess.wait)
...
case 'family100':
          if (!isGroup) return reply(mess.only.group)
				...
				Pertanyaan = randKey.result.soal
					setTimeout( () => {
					alpha.sendMessage(from, '*➸ Jawaban :* \n```'+randKey.result.jawaban +'', text, {quoted: ftex}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
					  reply('_Waktu Anda Habis_')
					}, 29000)
					setTimeout( () => {
					alpha.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
					setTimeout( () => {
					alpha.sendMessage(from, '_20 Detik lagi_…', text) // ur cods
					}, 10000) // 1000 = 1s,
					setTimeout( () => {
					alpha.sendMessage(from, '_30 Detik lagi_…', text) // ur cods
					}, 2500) // 1000 = 1s,
					setTimeout( () => {
					alpha.sendMessage(from, '*'+ Pertanyaan +'*', text, {quoted: ftex }) // ur cods
					}, 0) // 1000 = 1s,
...
case 'caklontong':
          if (!isGroup) return reply(mess.only.group)
				...
				Jawaban = '\n*'+randKey.result.desc +'*'
					setTimeout( () => {
					alpha.sendMessage(from, Jawaban, text, {quoted: ftex})
					}, 30000)
					setTimeout( () => {
					alpha.sendMessage(from, '_10 Detik lagi…_', text) // ur cods
					}, 20000) // 1000 = 1s,
					...
					alpha.sendMessage(from, Pertanyaan, text, {quoted: ftex})
...
case 'cecan':
                    sticWait(from)
                    cecan = await getBuffer(`http://api.lolhuman.xyz/api/random/cecan?apikey=BayuPerkasa`)
                    alpha.sendMessage(from, cecan, image, { quoted: ftex})
                    break
                    case 'cogan':
                    sticWait(from)
                    cogan = await getBuffer(`http://api.lolhuman.xyz/api/random/cogan?apikey=BayuPerkasa`)
                    alpha.sendMessage(from, cogan, image, { quoted: ftex})
                    break
                    case 'bts':
                    case 'exo':
                    case 'loli':
                    ...
                    case 'shinobu':
                    case 'megumin':
                    buffer = await getBuffer(`http://api.lolhuman.xyz/api/random/${command}?apikey=BayuPerkasa`)
...
case 'bj':
                    ...
                    case 'kemonomimi':
                    case 'nsfw_avatar':
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/random2/${command}?apikey=BayuPerkasa`)
                    alpha.sendMessage(from, ini_buffer, image, { quoted: ftex})
                    break
                    case 'ngif':
                    case 'nsfw_neko_gif':
                    ...
                    alpha.sendMessage(from, buff, sticker, { quoted: ftex})
                    fs.unlinkSync(rano)
                    })
                    break
case 'asupan':
			sticWait(from)
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/asupan?apikey=BayuPerkasa`)
                    buffer = await getBuffer(get_result.result)
                    alpha.sendMessage(from, buffer, video, { quoted: ftex, mimetype: Mimetype.mp4, filename: "asupan.mp4" })
                    break
case 'tiktokmusic':
                    ...
                    alpha.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, quoted: mek})                             
                    break                  
                    case 'tiktok':
                    case 'tiktoknowm':   	
                    if (args.length < 1) return reply(`Linknya Mana Cuy?\nContoh : ${prefix + command} Melukis Senja`)
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://vt.tiktok.com/ZSwWCk5o/`)
                    ini_link0 = args[0]
                    const data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=BayuPerkasa&url=${ini_link0}`)
                    ...
                    alpha.sendMessage(from, buff, video, {quoted: mek, caption: capt})
                    break       
case 'jadian':
if (!isGroup) return reply(mess.only.group)
jds = []
...
case 'randompatrick':
			       sticWait(from)
                    ...
                    alpha.sendMessage(from, anu, sticker, {quoted:ftex})
                    break
case 'bagaimanaka':
if (!isGroup) return reply(mess.only.group)
bagaimanakah = body.slice(1)
					...
					alpha.sendMessage(from, 'Pertanyaan : *'+bagaimanakah+'*\n\nJawaban : '+ mana, text, { quoted: mek })
				...
				if (!isGroup) return reply(mess.only.group)
					...
					alpha.sendMessage(from, 'Pertanyaan : *'+sange+'*\n\nJawaban : '+ nge+'%', text, { quoted: mek })
                ...
                case 'gaycek':
					...
					alpha.sendMessage(from, 'Pertanyaan : *'+gayy+'*\n\nJawaban : '+ yag+'%', text, { quoted: mek })
                ...
                case 'lesbicek':
					...
					alpha.sendMessage(from, 'Pertanyaan : *'+lesbii+'*\n\nJawaban : '+ bi+'%', text, { quoted: mek })
...
case 'ewe':
          if (!isGroup) return reply(mess.only.group)
           ganteng = body.slice(5)
					...
					alpha.sendMessage(from, ''+ganteng+''+ we +'', text, { quoted: mek })
					break
case 'seberapagay':
  if (!isGroup) return reply(mess.only.group)
 teks = body.slice(1)
...
watak = body.slice(1)
					...
					alpha.sendMessage(from, 'Pertanyaan : *'+watak+'*\n\nJawaban : '+ tak, text, { quoted: mek })
...
case 'hobby':
					...
					alpha.sendMessage(from, 'Pertanyaan : *'+hobby+'*\n\nJawaban : '+ by, text, { quoted: ftrol })
...
if (!isGroup) return reply(mess.only.group)
await alpha.toggleDisappearingMessages(from)
reply("yahaha")
break
...
alpha.sendMessage(from, suksez, text,{quoted : mek, contextInfo: { forwardingScore: 100, isForwarded: true}})
}, 20000) // 1000 = 1s,
setTimeout( () => {
...
if (args.length == 0) return reply(`Example: ${prefix + command} RazoR`)
                   ...
                   alpha.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Alpha Bot Wa`, quoted : fvoc})
                    })
                    break
                case 'pornhub':
                case 'glitch':
               ...
               sticWait(from)
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=BayuPerkasa&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        alpha.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `MEZ razor`, quoted : fvoc})
                    })
                    break
case 'fox':  
                   ...
                   alpha.sendMessage(from, anu1, image, {caption: `nih kak mirip kamu`, quoted: ftex})
                   break
                   case 'dog':  
...
case 'ownerr':
         case 'creator':  
         ini_ownerNumber = [`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`,`${NomorOwner}@s.whatsapp.net`]
					let ini_list = []
					...
					"contacts": ini_list 
					}, 'contactsArrayMessage', { quoted: fvoc})
...
alpha.sendMessage(from,  buttonMessagee, MessageType.buttonsMessage,{
        ...
        "contextInfo": {
			...
			quoted: ftex,sendEphemeral: true 
			})
					break
case 'owner':
let inilist = []
...
button = [
  ...
  {buttonId: '.youtube', buttonText: {displayText: 'YouTube'}, type: 1},
 {buttonId: '.tiktod', buttonText: {displayText: 'TikTok'}, type: 1}
]
 buttons = {
...
await alpha.sendMessage(from, buttons, MessageType.buttonsMessage, {quoted: fgi})
break
case 'youtube':
teks =
...
case 'tiktod':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://vt.tiktok.com/sif_78`
alpha.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'addcmd': 
case 'setcmd':
...
url = args[0]
url = await fetchJson(`https://api.lolhuman.xyz/api/instagram?apikey=78bd89cd7b4d6205e3e18061&url=${url}`)
url = url.result
type = image
if (url.includes(".mp4")) type = video
buffer = await getBuffer(url)
alpha.sendMessage(from, buffer, type, { quoted: ftex})
break
case 'fbdl':
sticWait(from)
if (args.length == 0) return reply(`Link Nya Mana Tod ?\nContoh : ${prefix + command} https://id-id.facebook.com/SamsungGulf/videos/video-bokeh/561108457758458/`)
url = args[0]
url = await fetchJson(`https://api.lolhuman.xyz/api/facebook?apikey=78bd89cd7b4d6205e3e18061&url=${url}`)
url = url.result[0].link
buffer = await getBuffer(url)
alpha.sendMessage(from, buffer, video, { quoted: ftex})
break
case 'tourl':
...
break
case 'sider':
infom = await alpha.messageInfo(from, dev.message.extendedTextMessage.contextInfo.stanzaId)
tagg = []
shape = '▢'
...
ini_link = args[0]
get_result = await fetchJson(`http://api.lolhuman.xyz/api/ytvideo2?apikey=78bd89cd7b4d6205e3e18061&url=${ini_link}`)
get_result = get_result.result
ini_txt = `${get_result.title} - ${get_result.size}`
ini_buffer = await getBuffer(get_result.thumbnail)
await alpha.sendMessage(from, ini_buffer, image, { quoted: ftex, caption: ini_txt })
get_audio = await getBuffer(get_result.link)
await alpha.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftex })
break
case 'ytsearch':
      ...
      case 'buttonmusic':
             ...
             sendMediaURL(from, `${res.dl_link}`,{quoted:fdoc})
             break         
     case 'buttonvideo':
             //if (!isRegister) return reply(mess.only.regis)      	     
             if(!c) return reply('linknya?')            
